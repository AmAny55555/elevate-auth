...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      {/* container (NO border-r / border-l) */}
      <div
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 items-center px-2 text-xs font-medium",
        className
      )}
      {...props}
    />
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-3 top-3.5 flex h-5 w-5 items-center justify-center rounded-md",
        className
      )}
      {...props}
    />
