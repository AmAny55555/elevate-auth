...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-[#f3f4f6] overflow-x-hidden">
      ...
      >
        ...
        <div
          className="
            ...
            [&_img:first-child]:hidden
            [&_img:first-child+*]:mt-0
            [&_img:first-child+*]:pt-0
          "
        >
          <Side />
        </div>
      ...
      <div className="py-6 pt-14 lg:pt-6">
        <div className="flex gap-6 max-w-[1440px] mx-auto px-4 lg:px-8">
          ...
          <div className="flex flex-col flex-1 min-w-0">
            ...
            <main className="mt-2 lg:mt-6 flex-1 min-w-0">{children}</main>
          </div>
        </div>
      </div>
    </div>
